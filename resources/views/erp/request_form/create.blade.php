...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <form method="POST" action="{{ route('erp.request-form.store') }}" class="card shadow-sm border-0 rounded-3 overflow-hidden" id="rfCreateForm" enctype="multipart/form-data">
    @csrf
          ...
          <div class="col-lg-6">
            ...
            @if($recordType === 'project')
              <div class="mb-3">
                ...
                <input name="project_code" class="form-control" value="{{ old('project_code') }}" placeholder="e.g. MP05922" required>
              </div>
            @else
    ...
    <div class="modal-content">
      <div class="modal-header border-bottom">
        <h5 class="modal-title fw-bold">
          <i class="bx bx-list-plus me-2 text-primary"></i>New RF Line Item
        </h5>
