                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    @if(auth()->user()->hasPermission('users.export_seeder'))
                                        <li><a class="dropdown-item" href="{{ route('erp.users.export.seeder') }}">Export Seeder (CSV)</a></li>
                                    @endif
    ...
    <div class="modal fade" id="glassAddUser" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0" style="background:#fff;">
                ...
                <form id="formAddUser" method="POST" action="{{ route('erp.users.store') }}" class="modal-body "
    ...
    <script>
        $(function() {
            ...
            $('#btnExportExcel').on('click', function(e) {
                ...
                let url = "{{ route('erp.users.exportExcel') }}";
            ...
            $('#btnBulkDelete').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (!res.isConfirmed) return;
                    fetch(@json(route('erp.users.bulk-destroy')), {
                        method: 'POST',
                        headers: {
